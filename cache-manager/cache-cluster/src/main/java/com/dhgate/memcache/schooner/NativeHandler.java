...
//	
//	public static final int  MARKER_BYTEARR = 13;
    ...
    */
	...
	public static byte[] encode(StringBuffer value) throws IOException
	{
	...
	public static byte[] encode(Short value) throws IOException
	{
	...
	public static byte[] encode(double value) throws IOException
	{
	...
	public static byte[] encode(float value) throws IOException
	{
	...
	public static Object decode(byte[] b) throws UnsupportedEncodingException
	{
	...
	/*	if (b[0] == MARKER_STRINGBUILDER)
            return decodeStringBuilder(b);

        if (b[0] == MARKER_BYTEARR)
	...
	public static String decodeString(byte[] b) throws UnsupportedEncodingException
	{
	...
	public static StringBuffer decodeStringBuffer(byte[] b) throws UnsupportedEncodingException
	{
	...
	public static Short decodeShort(byte[] b) throws UnsupportedEncodingException
	{
	...
	public static Long decodeLong(byte[] b) throws UnsupportedEncodingException
	{
	...
	public static Double decodeDouble(byte[] b) throws UnsupportedEncodingException
	{
	...
	public static Float decodeFloat(byte[] b) throws UnsupportedEncodingException
	{
