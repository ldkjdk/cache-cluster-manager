...
import com.dhgate.redis.clients.jedis.BinaryClient.LIST_POSITION;
...
public class BinaryShardedJedis extends Sharded<Jedis, JedisShardInfo>
    ...
    public BinaryShardedJedis(List<JedisShardInfo> shards,boolean isPolling) {
	super(shards, isPolling);
    }

    public BinaryShardedJedis(List<JedisShardInfo> shards, Hashing algo,boolean isPolling) {
	super(shards, algo, isPolling);
    }

    public BinaryShardedJedis(List<JedisShardInfo> shards, Pattern keyTagPattern,boolean isPolling) {
	super(shards, keyTagPattern, isPolling);
    }

    public BinaryShardedJedis(List<JedisShardInfo> shards, Hashing algo,
	    Pattern keyTagPattern,boolean isPolling) {
	super(shards, algo, keyTagPattern, isPolling);
    }
