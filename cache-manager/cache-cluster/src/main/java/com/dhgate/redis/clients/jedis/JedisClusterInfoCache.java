...
import com.dhgate.redis.clients.util.ClusterNodeInformation;
import com.dhgate.redis.clients.util.ClusterNodeInformationParser;
...
public class JedisClusterInfoCache {
    ...
    public JedisClusterInfoCache(final GenericObjectPool.Config poolConfig) {
