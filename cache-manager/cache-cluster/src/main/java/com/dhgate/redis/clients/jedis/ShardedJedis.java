...
public class ShardedJedis extends BinaryShardedJedis implements JedisCommands,
    ...
    public ShardedJedis(List<JedisShardInfo> shards,boolean isPolling) {
	super(shards, isPolling);
    }

    public ShardedJedis(List<JedisShardInfo> shards, Hashing algo,boolean isPolling) {
	super(shards, algo, isPolling);
    }

    public ShardedJedis(List<JedisShardInfo> shards, Pattern keyTagPattern,boolean isPolling) {
